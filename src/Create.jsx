...
<input type="checkbox" className="myCheckbox" name="myCheckbox"/>

<input className="DATA" type="text" value={task._id==editData?editTask:task.task} disabled={task._id==editData?false:true}  onChange={(e) => seteditTask(e.target.value)}/>
</div>  
          <div className="edit-del" key={task.id}>
            <div className="delete">
            <i onClick={()=> deleteitem(task._id)} className="material-symbols-outlined">delete</i>
            </div>
             
 {task._id!=editData? <div className="edit"> <i  onClick={()=> setEditData(task._id)} className="material-symbols-outlined">edit</i></div>:
           <div className="save">
